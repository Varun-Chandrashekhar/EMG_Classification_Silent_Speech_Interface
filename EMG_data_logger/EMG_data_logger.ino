...
void loop() {
  recordEMGSerial(); // Void loop for Serial Monitor output
...
void recordEMG() { // Recording EMG Optimized for speed
  for (int i = 1; i <= 3000; i++) {
    // rawEMG = analogRead(rawEMGPin);
    Data.print(String(analogRead(modEMGPin)) + ","); // print Raw EMG values
    //Data.print(","); // Print comma to seperate values
    //Data.print(analogRead(modEMGPin)); // print Modified EMG values
    //Serial.println(i); ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
  }
}

void recordEMGSerial() { // Recording EMG Optimized for speed
    modEMG = analogRead(modEMGPin);
    Serial.print(modEMG); // print Raw EMG values
    Serial.print(", "); // Print comma to seperate values
    Serial.print(1023); // Set Boudary for Plot
    Serial.print(","); // Print comma to seperate values
    Serial.println(0); // Set Boudary for Plot
    //Data.print(analogRead(modEMGPin)); // print Modified EMG values
    //Serial.println(i); ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
}
